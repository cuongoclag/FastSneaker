    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form class="sign-in-form" method="post" action="/forgot_password" onsubmit="return validateForm()">
            ...
            <div class="input-field">
              ...
              <input type="email" placeholder="Enter your email" name="email" required="required" autofocus="autofocus"/>
            </div>
