...
<html lang="en">
  ...
  <body class="ps-loading">
    ...
    <thead>
      <tr>
        <th class="text-center h3 font-weight-bold">Order Code</th>
        <th class="text-center h3 font-weight-bold">Order date </th>
        <th class="text-center h3 font-weight-bold">Total</th>
      </tr>
    </thead>
    <tbody>
